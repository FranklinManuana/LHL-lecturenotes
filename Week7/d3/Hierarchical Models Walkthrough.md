We are now going to practice **Hierarchical Models**.

Instruction

Access the [Unsupervised Learning](https://github.com/lighthouse-labs/unsupervised-learning) repository, and access the Hierarchical Model Tutorial.
